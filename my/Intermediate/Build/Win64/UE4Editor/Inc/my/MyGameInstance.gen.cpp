...
// Cross Module References
	MY_API UScriptStruct* Z_Construct_UScriptStruct_FMyCharacterData();
	UPackage* Z_Construct_UPackage__Script_my();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FTableRowBase();
	MY_API UClass* Z_Construct_UClass_UMyGameInstance_NoRegister();
	MY_API UClass* Z_Construct_UClass_UMyGameInstance();
...
class UScriptStruct* FMyCharacterData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MY_API uint32 Get_Z_Construct_UScriptStruct_FMyCharacterData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FMyCharacterData, Z_Construct_UPackage__Script_my(), TEXT("MyCharacterData"), sizeof(FMyCharacterData), Get_Z_Construct_UScriptStruct_FMyCharacterData_Hash());
	}
	return Singleton;
}
template<> MY_API UScriptStruct* StaticStruct<FMyCharacterData>()
{
	return FMyCharacterData::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FMyCharacterData(FMyCharacterData::StaticStruct, TEXT("/Script/my"), TEXT("MyCharacterData"), false, nullptr, nullptr);
static struct FScriptStruct_my_StaticRegisterNativesFMyCharacterData
{
	FScriptStruct_my_StaticRegisterNativesFMyCharacterData()
	{
		UScriptStruct::DeferCppStructOps<FMyCharacterData>(FName(TEXT("MyCharacterData")));
	}
} ScriptStruct_my_StaticRegisterNativesFMyCharacterData;
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMyCharacterData()
	{
		...
		UPackage* Outer = Z_Construct_UPackage__Script_my();
	...
	uint32 Get_Z_Construct_UScriptStruct_FMyCharacterData_Hash() { return 1897350896U; }
	...
	IMPLEMENT_CLASS(UMyGameInstance, 89259058);
	template<> MY_API UClass* StaticClass<UMyGameInstance>()
	{
		return UMyGameInstance::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMyGameInstance(Z_Construct_UClass_UMyGameInstance, &UMyGameInstance::StaticClass, TEXT("/Script/my"), TEXT("UMyGameInstance"), false, nullptr, nullptr, nullptr);
